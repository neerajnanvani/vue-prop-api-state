<template>
    <div class="my-10 mb-20 mx-20 flex flex-col space-y-30">
        <input class="mt-10 mb-20 border-gray-500 border rounded-lg mx-auto px-5 py-3 w-1/2 bg-gray-800 text-gray-200"
            placeholder="Search the User" v-model="searchText" />
